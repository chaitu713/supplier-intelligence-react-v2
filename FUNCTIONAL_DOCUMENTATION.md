...
The current system is a working prototype using CSV files as the data source. It has a React web application, a FastAPI backend, and multiple supplier intelligence modules.
...
The system currently uses CSV files in the `data/` folder.
